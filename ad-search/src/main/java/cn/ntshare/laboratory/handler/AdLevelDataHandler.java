...
import cn.ntshare.laboratory.dump.table.*;
import cn.ntshare.laboratory.index.DataTable;
import cn.ntshare.laboratory.index.IndexAware;
import cn.ntshare.laboratory.index.adplan.AdPlanIndex;
import cn.ntshare.laboratory.index.adplan.AdPlanObject;
import cn.ntshare.laboratory.index.adunit.AdUnitIndex;
import cn.ntshare.laboratory.index.adunit.AdUnitObject;
import cn.ntshare.laboratory.index.creative.CreativeIndex;
import cn.ntshare.laboratory.index.creative.CreativeObject;
import cn.ntshare.laboratory.index.creativeunit.CreativeUnitIndex;
import cn.ntshare.laboratory.index.creativeunit.CreativeUnitObject;
import cn.ntshare.laboratory.index.district.UnitDistrictIndex;
import cn.ntshare.laboratory.index.interst.UnitItIndex;
import cn.ntshare.laboratory.index.keyword.UnitKeywordIndex;
